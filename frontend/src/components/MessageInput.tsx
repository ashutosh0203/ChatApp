...
const MessageInput = ({selectedUser, message,setMessage, handleMessageSend}:MessageInputProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col gap-2 border-t border-r-gray-700 pt-2'>
        {
            imageFile && (<div className="relative w-fit">
                <img className='w-24 h-24 object-cover rounded-lg border border-r-gray-600'/>
