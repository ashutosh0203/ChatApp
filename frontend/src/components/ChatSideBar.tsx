...
const ChatSideBar = ({siderbarOpen, setSidebarOpen, setShowAllUser,showAllUser, users, loggedInUser, chats, selectedUser,setSelectedUser, handleLogout, createChat,}:ChatSideBarProps) => {
  const [searchQuery, setSearchQuery] = useState("");
    ...
    <aside className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-r border-gray-700 transform ${
        siderbarOpen ? "translate-x-0" : "-translate-x-full"}
     ...
     `}>
        ...
        <div className="p-6 border-b border-gray-700">
          ...
          <div className="flex items-center justify-between ">
            ...
            <button className={`p-2.5 rounded-lg transition-colors ${
                showAllUser ? "bg-red-600 hover:bg-red-700 text-white" : "bg-green-600 hover:bg-green-700-700 text-white"
            }`}
                            ...
                            <div className="space-y-2 overflow-y-auto h-full pb-4">
                                {
                                    chats.map((chat)=>{
                                        ...
                                        className={`w-full text-left p-4 rounded-lg transition-colors
                                            ${isSelected
                                                ?"hover:bg-blue-400 border-blue-500"
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className='flex-1 min-w-0'>
                                                        <div className="flex items-center justify-between mb-1">
                                                            ...
                                                            {
                                                                unseenCount>0 && <div className="bg-red-600 text-white
                                                                text-xs font-bold rounded-full min-w-5.5 h-5.5 flex items-center justify-center px-2">
        ...
        <div className="p-4 border-t border-gray-700 space-y-2">
            ...
            <button onClick={handleLogout} className='w-full flex items-center gap-3 px-4 py-3 rounded-lg
